      ...
      child: Row(
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: Image.asset(
              "assets/images/gambar14.jpg.png",
              width: 100,
              height: 200,
  ...
  final List<Map<String, dynamic>> freelancers = [
    {
      ...
      "profession": "Youtuber",
      "rating": 5.5,
      "image": "assets/images/gambar8.jpg.jpg"
    },
    {
      "name": "Kim Junkyu",
      "profession": "Beautician",
      "rating": 4.9,
      "image": "assets/images/gambar9.jpg.jpg"
    },
    {
      "name": "Asahi",
      "profession": "Beautician",
      "rating": 4.9,
      "image": "assets/images/gambar10.jpg.jpg"
    },
    {
      "name": "Park Jihoon",
      "profession": "Beautician",
      "rating": 4.9,
      "image": "assets/images/gambar11.jpg.jpg"
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        const SizedBox(height: 10),
        ServiceCard(
          imageUrl: 'assets/images/gambar3.jpg.jpg',
          name: 'Album Treasure',
          role: 'Merchandise',
          description: 'Ini adalah album treasure',
          rating: 4.9,
        ),
        ServiceCard(
          imageUrl: 'assets/images/gambar4.jpg.jpg',
          name: 'Boneka Bon Bon Treasure',
          role: 'Merchandise',
          description: 'Ini adalah boneka treasure',
          rating: 5.5,
        ),
        ServiceCard(
          imageUrl: 'assets/images/gambar5.jpg.jpg',
          name: 'Lighstick Treasure',
          role: 'Merchandise',
          description: 'Ini adalah lighstick treasure',
          rating: 4.9,
        ),
      ],
    );
...
class BestBooking2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
        children: [
          BestBookingCard(
            imageUrl: 'assets/images/gambar13.jpg.jpg',
            profileUrl: 'assets/images/gambar10.jpg.jpg',
            name: 'Asahi',
            role: 'Member Treasure',
          ...
          BestBookingCard(
            imageUrl: 'assets/images/gambar13.jpg.jpg',
            profileUrl: 'assets/images/gambar13.jpg.jpg',
            name: 'Kim Junkyu',
            role: 'Member Treasure',
            description: 'Occaecati aut nam beatae quo non deserunt consequatur.',
            rating: 4.9,
            ...
            Stack(
              children: [
                ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/gambar13.jpg.jpg', // Ganti dengan path gambar Anda
                    height: 230,
                    width: double.infinity,
                    fit: BoxFit.cover,
                  ),
